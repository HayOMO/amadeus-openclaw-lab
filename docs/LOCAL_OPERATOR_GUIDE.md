...
This document preserves the detailed machine-local setup and operating notes. For the public project overview, see [README](../README.md) or [简体中文](../README.zh-CN.md).
...
- Default chat profile: `balanced`, currently backed by `openai/gpt-5.6-sol` with medium reasoning.
...
powershell -ExecutionPolicy Bypass -File .\scripts\SET_IMAGEBOT_MODEL_MODE.ps1 -Mode custom -Model openai/gpt-5.6-sol -ReasoningEffort high -TextVerbosity low -MaxTokens 1536
```
...
/ammodel
/ammodel models
/ammodel model openai/gpt-5.6-sol
/ammodel model openai/gpt-5.6-sol think xhigh
